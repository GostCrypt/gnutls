...
#if 0
const struct ecc_curve * NETTLE_PURE nettle_get_gost_256cpb(void);
const struct ecc_curve * NETTLE_PURE nettle_get_gost_256cpc(void);
const struct ecc_curve * NETTLE_PURE nettle_get_gost_512b(void);
#endif
